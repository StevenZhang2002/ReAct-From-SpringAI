...
/**
 * ReactAgent - 基于 ReAct 范式的智能体实现（追踪审计版本）。
 * <p>
 * 本节新增：enableTrace 属性。
 *
 * @author bigchui
...
public class ReactAgent {
    ...
    private final LongTermMemoryConfig longTermMemory;
    ...
    private AgentLoopExecutor createExecutor() {
        ...
        LongTermMemoryManager memoryManager = longTermMemory != null ? new LongTermMemoryManager(longTermMemory) : null;
    ...
    public LongTermMemoryConfig getLongTermMemory() { return longTermMemory; }
    public boolean isEnableTrace() { return enableTrace; }
    ...
    public static class Builder {
        ...
        public Builder longTermMemory(LongTermMemoryConfig config) { this.longTermMemory = config; return this; }
        public Builder enableTrace(boolean enableTrace) { this.enableTrace = enableTrace; return this; }
