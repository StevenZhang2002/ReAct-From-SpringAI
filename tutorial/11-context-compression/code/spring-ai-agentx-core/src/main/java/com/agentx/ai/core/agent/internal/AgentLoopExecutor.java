...
/**
 * Agent ReAct 循环执行器 — 集成上下文压缩。
 * <p>
 * 本节新增：contextCompactor 属性，在每轮 LLM 调用前自动压缩过长的上下文。
 *
 * @author bigchui
 */
public class AgentLoopExecutor {
    ...
    public AgentLoopExecutor(ChatClient chatClient, LoopMessageBuilder messageBuilder,
        ...
        this(chatClient, messageBuilder, toolCallExecutor, maxRounds, null, null, null, null, null, null);
    }
