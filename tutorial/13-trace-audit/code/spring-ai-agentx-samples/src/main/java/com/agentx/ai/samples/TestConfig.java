...
/**
 * 示例公共配置 — 从 secrets.properties 读取 API 配置，构造 ChatModel、EmbeddingModel 与 H2 内存数据库。
 * <p>
...
public final class TestConfig {
    ...
    /**
     * 创建 OpenAI 兼容协议的 EmbeddingModel（与 ChatModel 同一 API Key）。
     */
    public static EmbeddingModel createEmbeddingModel() {
        OpenAiEmbeddingOptions options = OpenAiEmbeddingOptions.builder()
                .model(s("embedding.model", "text-embedding-v3"))
                .dimensions(1024)
                .build();
